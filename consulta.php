                    ...
                    <nav class="navbar bg-ligth">
                        <div class="container-fluid">
                            <a class="navbar-brand" href="#">
                                <img src="img/bootstrap-logo.png" alt="" width="30" heigth="24" class="d-inline-block align-text-top">
                                    Sistema Web 2.0
                                </a>
                            </div>
                        </nav>
...
<div class="row">
    <div class="col">
        <nav class="navbar bg-ligth">
            <div class="container-fluid">
                <span class="navbar-brand">Listas de Usuarios</span>
            </div>
        </nav>
    </div>
</div>
        ...
        <div class="col">
            ...
            <tr>
                <th scope="row">2</th>
                    ...
                    <th scope="row">3</th>
                        <td colspan="2">Larry the Bind </td>                  
                            <td>
                                <button type="button" class="btn btn-dark">Editar</button>
                                    <button type="button" class="btn btn-dark">Excluir</button>
                                    </td>
